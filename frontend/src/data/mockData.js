...
import { generateFloorTiles } from "../services/layoutGeneration.js";
...
// partir de lui via generateFloorTiles (services/layoutGeneration.js),
...
// pour distinguer visuellement une pièce de sa voisine. `layoutArea`
// reste utilisé par ApartmentOverview2D (vue d'ensemble en cartes,
// disposition indépendante de la géométrie réelle du plan).
...
export const MOCK_ROOMS = [
  {
    ...
    icon: "🛋️",
    color: "#f3e6d0",
    layoutArea: { gridColumn: "1", gridRow: "1" },
  },
  {
    id: "room-couloir",
    name: "Couloir",
    ...
    icon: "🚪",
    color: "#e7e5df",
    layoutArea: { gridColumn: "1 / span 2", gridRow: "2" },
  },
  {
    id: "room-cuisine",
    name: "Cuisine",
    ...
    icon: "🍳",
    color: "#fdecc8",
    layoutArea: { gridColumn: "2", gridRow: "1" },
  },
  {
    id: "room-chambre",
    name: "Chambre",
